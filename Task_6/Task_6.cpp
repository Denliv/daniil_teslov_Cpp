...
namespace Task6
{
	...
	public:
		TEST_METHOD(TestMethod1) {
			...
			Logger::WriteMessage((dic1.toLevelStringWithBalance(dic1.getRootCopy(), 0) + "\n").c_str());
			...
			Logger::WriteMessage((dic2.toLevelStringWithBalance(dic2.getRootCopy(), 0) + "\n").c_str());
			Logger::WriteMessage("ADD D =>\n");
			...
			Logger::WriteMessage((dic3.toLevelStringWithBalance(dic3.getRootCopy(), 0) + "\n").c_str());
